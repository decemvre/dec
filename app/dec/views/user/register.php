			...
			<div class="col-xs-offset-3 col-xs-6">
				...
				<form id="form-register" action="<?= Url::to('user', 'register') ?>" method="post", role="form">
					<div class="form-group">
						...
						<input name="RegisterForm[name]" type="text" class="form-control" id="InputName" placeholder="Fullt navn">
					</div>
					<div class="form-group">
						<label for="InputEmail">E-post address</label>
						<input name="RegisterForm[email]" type="email" class="form-control" id="InputEmail" placeholder="E-post">
					</div>
					<div class="form-group">
						<label for="InputPassword">Password</label>
						<input name="RegisterForm[password]" type="password" class="form-control" id="InputPassword" placeholder="Passord">
					</div>
					<div class="checkbox">
						<label>
